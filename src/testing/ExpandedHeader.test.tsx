...
import { defaultBannerProps } from "../library/sections/BannerSection.tsx";
        ...
        PrimaryHeaderSlot: [
          {
            type: "PrimaryHeaderSlot",
            props: {
              id: "PrimaryHeaderSlot-437e31cf-f7f5-4174-aceb-7bc905cbb1f3",
              styles: {
                backgroundColor: {
                ...
                LogoSlot: [
                  {
                    type: "ImageSlot",
                    props: {
                      id: "ImageSlot-ccc0709b-733a-4ab7-8121-91a4891eb8a4",
                      data: {
                        image: {
                          field: "",
                          constantValue: {
                ...
                LinksSlot: [
                  {
                    type: "HeaderLinks",
                    props: {
                      id: "HeaderLinks-4fe8d60f-cbac-4b9a-99ae-6cdd5b15b2e7",
                      data: {
                        links: [
                          {
                            linkType: "URL",
                ...
                PrimaryCTASlot: [
                  {
                    type: "CTASlot",
                    props: {
                      id: "CTASlot-99fd20f6-de9a-47e4-b498-6b98c715f89a",
                      data: {
                        show: true,
                        actionType: "link",
                        normalizeLink: true,
                ...
                SecondaryCTASlot: [
                  {
                    type: "CTASlot",
                    props: {
                      id: "CTASlot-d4b91ca6-20a0-43d7-a861-059ae799e29f",
                      data: {
                        show: true,
                        actionType: "link",
                        normalizeLink: true,
                ...
                SecondaryHeaderSlot: [
                  {
                    type: "SecondaryHeaderSlot",
                    props: {
                      id: "SecondaryHeaderSlot-07c34555-239a-4a2e-8d86-e830e7998d46",
                      data: {
                        show: true,
                        showLanguageDropdown: false,
                      },
                        ...
                        LinksSlot: [
                          {
                            type: "HeaderLinks",
                            props: {
                              id: "HeaderLinks-e981b386-fa02-46d2-888b-fc9513083077",
                              data: {
                                links: [
                                  {
                                    linkType: "URL",
